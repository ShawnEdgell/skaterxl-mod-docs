export const mods = [
    {
        ...
        modItems: [
            ...
            },
            {
                ...
                features: ['Flexible Object Movement', 'Group Manipulation', 'Advanced Scaling', 'Preset Saves'],
                note: '',
                downloadLinks: [
                    { url: 'https://mod.io/g/skaterxl/m/better-object-dropper-mod-by-manu-mu35li', label: 'skaterxl.mod.io' }
                ]
            },
            {
                icon: '🔥',
