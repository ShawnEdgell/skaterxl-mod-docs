...
<div class="flex flex-col justify-center bg-custom-bluegray-light">
	<!-- Main Header -->
	<header
		class="sticky px-4 top-0 z-9999 py-2 px flex items-center justify-between w-full max-w-5xl bg-custom-bluegray-light"
	>
		<div class="flex flex-col w-full">
			<div class="flex flex-row justify-between items-center w-full">
				...
				<nav class="hidden md:flex space-x-10">
					<a href="/" sveltekit-prefetch class="text-sm text-white">Home</a>
					<a href="/GettingStarted" sveltekit-prefetch class="text-sm text-white">Getting Started</a
					>
					<a href="/Maps&Gear" sveltekit-prefetch class="text-sm text-white">Maps & Gear</a>
					<a href="/XLHub" sveltekit-prefetch class="text-sm text-white">XL Hub</a>
					<a href="/Stats" sveltekit-prefetch class="text-sm text-white">Stats</a>
				</nav>

				<!-- Custom Menu Button with Increased Click Radius -->
				<button on:click={toggleMenu} class="md:hidden flex items-center justify-center -m-">
	...
	{#if showMenu}
		<nav class="md:hidden flex flex-col items-center w-full bg-custom-bluegray-light p-2">
