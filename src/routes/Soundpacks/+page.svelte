...
<div class="max-w-4xl mx-auto py-6">
	<h1>Soundpacks</h1>
	<p>
		Dive into a diverse collection of soundpacks for the SoundMod, designed to enhance your Skater
		XL experience with customized audio landscapes. Each soundpack offers unique sounds for gameplay
		and UI, allowing you to tailor the auditory experience to your preference.
	</p>
	...
	<div class="note">
		<p>
			<b>Tip: </b>You can easily swap between different Soundpacks by deleting all your old sounds
			and dragging new ones in, or by simply "Replacing" your entire Sounds folder with a new one.
		</p>
	</div>
