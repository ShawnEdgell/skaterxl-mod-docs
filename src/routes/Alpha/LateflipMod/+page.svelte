...
<div class="max-w-4xl mx-auto py-6">
  ...
  <div class="flex flex-col md:flex-row p-4 border bg-gray-200 rounded-lg">
    <div class="flex-1 md:mr-4">
      ...
      <p class="mb-1"><b>Download: </b><a href="https://mod.io/g/skaterxl/m/lateflipmod" class="text-blue-600 hover:underline" target="_blank" rel="noopener noreferrer">skaterxl.mod.io</a></p>
      <p class="mb-1"><b>Keybind to Toggle:</b> SpecifiedKey</p>
      <p class="mb-1"><b>Key Features:</b> Realistic Late Flip Mechanics, Advanced Controls, Seamless XXL3 Integration, Customizable Settings</p>
    </div>

    <div class="flex-1 mt-4 md:mt-0">
      <img src="/Picture.png" alt="Lateflip Mod" class="w-full h-auto rounded-lg shadow-md"/>
    </div>
  </div>

  <h2>Download + Installation</h2>
  <p>
    Download the Lateflip Mod from <a href="https://mod.io/g/skaterxl/m/lateflipmod" class="text-blue-600 hover:underline" target="_blank" rel="noopener noreferrer">skaterxl.mod.io</a>. Ensure you download the compatible version for your Skater XL game.
  </p>
  <p>
