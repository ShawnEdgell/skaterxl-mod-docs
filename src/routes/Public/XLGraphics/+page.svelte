...
<div class="max-w-4xl mx-auto py-6">
  ...
  <p>
    To download and install the XL Graphics Mod v2.0.2, head to <a href="https://discord.gg/mBJ5wCchVm" target="_blank" rel="noopener noreferrer">Fro's Discord</a> (#open-source-mods section). Make sure to grab the version that corresponds to your Skater XL version. 
  </p>
  <p>
