...
<div class="main-container">
		...
		<div>
			...
			<p>
				<b>Download: </b><a
					...
					target="_blank"
					rel="noopener noreferrer">Fro's Discord</a
				> (#open-source-mods section)
			</p>
			<p><b>Keybind to Open:</b> Backspace</p>
			<p>
				<b>Key Features:</b> Camera Customization, Fisheye Lens Effect, Follow Camera, Community-driven
				Presets
			</p>
		</div>
	...
	<p>
		To download and install the XL Graphics Mod v2.0.2, head to <a
			href="https://discord.gg/mBJ5wCchVm"
			target="_blank"
			rel="noopener noreferrer">Fro's Discord</a
		> (#open-source-mods section). Make sure to grab the version that corresponds to your Skater XL version.
	</p>
	<p>
	...
	<p>
		To access the mod in-game, press <b>Backspace</b> on your keyboard. The mod interface is divided
		into three sections: Basic, Presets, and Camera. Each section offers different customization options:
	</p>
