<script>
    // Page1.svelte script if needed
</script>

<article class="p-4">
    <h1 class="text-2xl font-bold mb-4">Fro's Experimental Mod</h1>
    ...
    <p>Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Sed in elementum orci. Ut non magna accumsan, tempor odio in, ultricies massa.</p>
</article>